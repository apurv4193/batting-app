...
<section class="content-header">
    <h1>
        ...
        <small>{{trans('adminlabels.game')}}</small>
        <div class="pull-right">
            <a href="{{ url('admin/add-game') }}" class="btn btn-block btn-primary add-btn-primary pull-right">{{trans('adminlabels.add')}}</a>
        </div>       
    </h1>
</section>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">{{trans('adminlabels.game_list')}}</h3>
                </div>
                <div class="box-body">
                    <table id="listGame" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>{{trans('adminlabels.game_list_name_label')}}</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.btn-delete-game', function(e){
            ...
            var cmessage = 'Are you sure you want to Delete this Game ?';
            var ctitle = 'Delete Game';
